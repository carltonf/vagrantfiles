...
class ActionModule(ActionBase):
    ...
    def _load_options_and_status(self, task_vars):
        ...
        if self._task._role:
            ...
            for v in C.DEFAULT_ROLES_PATH:
                # The printed value is actually a 
                # print('DBG:> C.DEFAULT_ROLES_PATH: ' + v)
                searchpath.insert(1, v)
    ...
    def run(self, tmp=None, task_vars=None):
        ...
        # dbg
        for p in _vars['searchpath']:
            print ( 'DBG:> searchpath: ' + p )
        # dbg ends
